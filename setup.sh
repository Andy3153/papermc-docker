...
# {{{ Message
  echo "\033[34m#### PaperMC Docker Image: building... ####"
# }}}

# {{{ Installing dependencies
  echo "\033[34m\n#### Installing dependencies ####\033[0m\n"
  apt update
  apt install --yes curl wget openjdk-17-jre screen
# }}}
...
# {{{ Create user
  ...
  useradd --uid $_uid --home-dir $_papermcfolder --comment "PaperMC Server" $_user
